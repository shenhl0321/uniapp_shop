...
/***/ 56:
/*!************************************************************************************************!*\
  !*** /Users/hongliangshen/Desktop/uniapp_shop/cwt_shop/main.js?{"page":"pages%2Fhome%2Fhome"} ***!
  \************************************************************************************************/
...
var _home = _interopRequireDefault(__webpack_require__(/*! ./pages/home/home.vue */ 57));
// @ts-ignore
...
/***/ 57:
/*!*****************************************************************************!*\
  !*** /Users/hongliangshen/Desktop/uniapp_shop/cwt_shop/pages/home/home.vue ***!
  \*****************************************************************************/
/*! no static exports found */
...
/* harmony import */ var _home_vue_vue_type_template_id_92bb8f34___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./home.vue?vue&type=template&id=92bb8f34& */ 58);
/* harmony import */ var _home_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./home.vue?vue&type=script&lang=js& */ 60);
...
/* harmony import */ var _home_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./home.vue?vue&type=style&index=0&lang=scss& */ 63);
...
/***/ 58:
/*!************************************************************************************************************!*\
  !*** /Users/hongliangshen/Desktop/uniapp_shop/cwt_shop/pages/home/home.vue?vue&type=template&id=92bb8f34& ***!
  \************************************************************************************************************/
...
try {
  components = {
    shopCard: function () {
      return Promise.all(/*! import() | components/shopCard/shopCard */[__webpack_require__.e("common/vendor"), __webpack_require__.e("components/shopCard/shopCard")]).then(__webpack_require__.bind(null, /*! @/components/shopCard/shopCard.vue */ 467))
    },
    tabbar: function () {
...
var render = function () {
  ...
  var g0 = _vm.pictureList.length
  var g1 = g0 !== 0 ? _vm.pictureList.length : null
  var g2 = _vm.pictureList.length
  var g3 = _vm.noticeList.length
  if (!_vm._isMounted) {
...
/***/ 60:
/*!******************************************************************************************************!*\
  !*** /Users/hongliangshen/Desktop/uniapp_shop/cwt_shop/pages/home/home.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 61:
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/hongliangshen/Desktop/uniapp_shop/cwt_shop/pages/home/home.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  computed: {
    nowTime: function nowTime() {
      var now = new Date();
      var formatTime = this.$utils.formatTime(now);
  ...
  methods: {
    ...
    //仅获取指定店铺
    getTheShop: function getTheShop(lat, lng) {
      var _this = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _this.$request.get('/shop/shop/authorityShop', {
                  lat: lat || _this.address.latitude,
                  lng: lng || _this.address.longitude
                });
              case 3:
                res = _context.sent;
                _this.shopList = [res];
    ...
    //获取周边建筑
    getNearBy: function getNearBy(latitude, longitude) {
        ...
        return _regenerator.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                current = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : 1;
                _context2.prev = 1;
                _context2.next = 4;
                return _this2.$request.get('/shop/shop/page', {
                  current: current,
                  state: 0
                  // lat,
                  // lng
              ...
              case 4:
                ...
                if (res.current == 1) {
                  ...
                  list = _this2.shopList;
                  list = list.concat(res.records);
                }
                _this2.shopList = list;
                _this2.pages = res.pages;
                _this2.current = res.current;
                _context2.next = 15;
                break;
              case 12:
                _context2.prev = 12;
    ...
    handleSearch: function handleSearch() {
      ...
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3() {
        var shopName, res, list;
        return _regenerator.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                shopName = _this3.searchValue;
                if (!shopName) {
                  _context3.next = 17;
                  break;
                }
                ...
                _this3.current = 1;
                _context3.next = 6;
                return _this3.$request.get('/search/searchShop', {
                  current: _this3.current,
                  shopName: _this3.searchValue,
                  lat: _this3.address.latitude,
                  lng: _this3.address.longitude
                });
              case 6:
                res = _context3.sent;
                list = [];
    ...
    goHomeIndeed: function goHomeIndeed(e) {
    ...
    getLocation: function getLocation(alreadyCheck) {
      var _this4 = this;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                }).then(function (ifAuthorizeLocation) {
    ...
    getHomepictureAndNotice: function getHomepictureAndNotice() {
      var _this5 = this;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.prev = 0;
                _context5.next = 3;
                return _this5.$request.get('/p/picture/homePageData');
              case 3:
                res = _context5.sent;
                _this5.pictureList = res.indexList || [];
                _this5.noticeList = res.noticeList || [];
                _this5.advertising = res.backgroundImage;
                _context5.next = 12;
                break;
              case 9:
                _context5.prev = 9;
...
/***/ 63:
/*!***************************************************************************************************************!*\
  !*** /Users/hongliangshen/Desktop/uniapp_shop/cwt_shop/pages/home/home.vue?vue&type=style&index=0&lang=scss& ***!
  \***************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
